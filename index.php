...
<body class="nav-md">
    ...
    <div class="main_container">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <center>
              &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span>
                  <font size="4.95" color="white" face="Helvetica Neue">APLIKASI IMB</font>
                </span></a>
            </center>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a href="#"><i class="fa fa-desktop"></i> Permohonan IMB <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil">Tampil Data</a></li>
                    <li><a href="index.php?page=tambah_imb">Tambah Data</a></li>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-gear"></i> Akun <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/image.png" alt=""><?php echo $_SESSION['email'] ?>
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2021 Aplikasi IMB : Novilawati
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"662df3739a8dd1ab","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.5.2","si":10}'></script>
